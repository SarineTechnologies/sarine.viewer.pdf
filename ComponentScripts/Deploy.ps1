...
#Create site
Write-Output "Copy js files to s3.."
...
if($envType -eq "prod"){
	$siteUri = "http://viewer-api.sarine.com/cache/v2/atom/sarine.viewer.pdf"
}
else{
	$siteUri = "http://viewer-api-$envId.$envName.sarine.com/cache/v2/atom/sarine.viewer.pdf"
}
